...
def profile(request, username):
    ...
    context = {
        'profile_user': user,
        'user_profile': profile,  # Ensure you are passing the updated profile instance
        'profile_picture': profile.profile_picture.url if profile.profile_picture else '/static/default.jpg',
